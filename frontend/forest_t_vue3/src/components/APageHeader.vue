<template>
  <div class="layout-header">
    <div class="layout-header-left">
      ...
      >
        <n-icon :component="KeyboardDoubleArrowRightOutlined" size="28" v-if="collapsed" />
        <n-icon :component="KeyboardDoubleArrowLeftFilled" size="28" v-else />
      </div>
      <n-breadcrumb>
...
<script>
  import { KeyboardDoubleArrowRightOutlined, KeyboardDoubleArrowLeftFilled, LogOutRound } from '@vicons/material';
  ...
  export default defineComponent({
    ...
    setup(props) {
      ...
      const avatarDropdownOptions = [{ label: '退出', key: 'logout', icon: renderIcon(LogOutRound) }];
